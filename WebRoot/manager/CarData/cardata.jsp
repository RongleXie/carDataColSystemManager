       ...
       <div class="container-fluid">
        <div class="row">
                    ...
                    <li>
                        ...
                        <ul id="systemSetting" class="nav nav-list collapse secondmenu" style="height: 0px;">
                         <li><a href="user!adminQueryPage.action"><i class="glyphicon glyphicon-user"></i>用户管理</a></li>
                            <li><a href="cardata!adminQueryPage.action"><i class="glyphicon glyphicon-th-list"></i>数据管理</a></li>
            ...
            <c:choose > 
                ...
                <jsp:include page="cardata_add.jsp"></jsp:include>
                </c:when>
                <c:when test="${param.flag eq 'update'}">
                <jsp:include page="cardata_update.jsp"></jsp:include>
                </c:when>
                <c:when test="${param.flag eq 'search'}">
                <jsp:include page="cardata_serach.jsp"></jsp:include>
                </c:when>
                <c:otherwise>
                <jsp:include page="cardata_list.jsp"></jsp:include>
                </c:otherwise>
            </c:choose>
            </div>
        </div>
