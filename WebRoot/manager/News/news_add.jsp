...
<form action="news!add.action" method="post">
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="text" name="news.promulgator"/></td>
    </tr>   
    <tr>
        <td class="tableleft">新闻类型</td>
        <td>
            <input type="radio" name="news.newstype" value="行业新闻" checked/> 行业新闻
            <input type="radio" name="news.newstype" value="公司新闻"/> 公司新闻
        </td>
    </tr>
    <tr>
