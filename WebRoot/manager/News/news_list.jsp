...
<form class="form-inline definewidth m20" action="index.html" method="get">  
    ...
    <button type="submit" class="btn btn-primary">查询</button>&nbsp;&nbsp; <a href="<%=basePath%>manager/News/news.jsp?flag=add"><button type="button" class="btn btn-success" id="addnew">新增新闻</button></a>
</form>
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <tr>
        ...
        <th width="18%">新闻管理</th>
			...
			<c:forEach items="${news}" var="n" varStatus="coun">
	     <tr>
            ...
            <td>${n.clicknum}</td>
            <td>
                  <a href="<%=basePath%>manager/News/news.jsp?flag=update&id=${n.id}">编辑</a>
                  <a href="<%=basePath%>news!delete.action?id=${n.id}"  onclick="del()">删除</a>
            </td>
    </c:forEach>
        </tr></table>
...
<div class="inline pull-right page">
        <pg:pager items="${count}" maxPageItems="10"
            export="currentNum=pageNumber" url="news!adminQueryPage.action" >
            <pg:first>
                <a href="${pageUrl}">首页</a>
            </pg:first>
            <pg:prev>
